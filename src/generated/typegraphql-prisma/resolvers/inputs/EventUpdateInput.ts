...
import { AnomalyUpdateOneWithoutEventsInput } from "../inputs/AnomalyUpdateOneWithoutEventsInput";
...
export class EventUpdateInput {
  ...
  @TypeGraphQL.Field(_type => AnomalyUpdateOneWithoutEventsInput, {
    nullable: true
  })
  anomaly?: AnomalyUpdateOneWithoutEventsInput | undefined;
}
