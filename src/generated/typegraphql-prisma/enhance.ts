...
const actionResolversMap = {
  Anomaly: {
    anomaly: actionResolvers.FindUniqueAnomalyResolver,
    findFirstAnomaly: actionResolvers.FindFirstAnomalyResolver,
    anomalies: actionResolvers.FindManyAnomalyResolver,
    createAnomaly: actionResolvers.CreateAnomalyResolver,
    deleteAnomaly: actionResolvers.DeleteAnomalyResolver,
    updateAnomaly: actionResolvers.UpdateAnomalyResolver,
    deleteManyAnomaly: actionResolvers.DeleteManyAnomalyResolver,
